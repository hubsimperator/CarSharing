...
public class NotificationUtils extends ContextWrapper {
    ...
    public void createChannels() {
        ...
        iosChannel.setLockscreenVisibility(android.app.Notification.VISIBILITY_PUBLIC);
        getManager().createNotificationChannel(iosChannel);
    }

    @RequiresApi(api = Build.VERSION_CODES.O)
    public android.app.Notification.Builder getAndroidChannelNotification(String title, String body, PendingIntent intent) {

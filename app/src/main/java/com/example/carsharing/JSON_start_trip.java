...
public class JSON_start_trip {
    ...
    String GrupaProjektu = null, NrProjektu=null;
    int BookingID = 0;

    public void StartUpdate(String _GrupaProjektu,String _NrProjektu, int _BookingID, Context context) {
        con = context;
    ...
    private class HttpAsyncTask2 extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.contains("False")) {
                alertDialog = new AlertDialog.Builder(con)
                        .setTitle("Błąd")
                        .setMessage("Błąd podczas rozpoczęcia")
